...
{
    public static class CardRepresentationExtensions
    {
        public static CardUpdatedSessionEventArgs ConvertToUpdateEvent(this CardRepresentation cardRepresentation, bool faceDown)
        {
        ...
        public static CardUpdatedSessionEventArgs ConvertToUpdateEventForPlayer(this Card card, Player player, bool forceFaceup)
        {
            ...
            update.Controller = card.GetControllingPlayer().m_PlayerId;
            return update;
        }
    }
}
